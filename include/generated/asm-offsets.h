...
#define THREAD_CPU_CONTEXT 2688 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4240 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_MTE_CTRL 4232 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 3656 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 3480 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
...
#define TRAMP_VALIAS -10555392 /* TRAMP_VALIAS */
